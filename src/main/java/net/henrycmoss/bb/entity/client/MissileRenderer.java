...
public class MissileRenderer<T extends AbstractMissile> extends EntityRenderer<T> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(Bb.MODID, "missile");
